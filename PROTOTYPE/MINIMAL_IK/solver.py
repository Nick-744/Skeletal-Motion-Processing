...
class Solver:
  ...
  def get_derivative(self, model: object, params: np.ndarray, n: int) -> np.ndarray:
    '''
  ...
  def solve(self,
    ...
    if init is None: init = np.zeros(model.n_params)
    ...
    for i in range(self.max_iter):
      ...
      if self.verbose: print(i, self.timer.tic(), mse)
